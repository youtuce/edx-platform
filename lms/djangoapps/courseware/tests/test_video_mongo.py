...
class TestEditorSavedMethod(BaseTestXmodule):
    ...
    def test_editor_saved_when_html5_sub_not_exist(self):
        ...
        file_name = 'subs_3_yD_cEKoCk.srt.sjson'
        # pylint: disable=no-value-for-parameter
        test_dir = path(__file__).abspath().dirname().dirname().dirname().dirname().dirname()
        file_path = test_dir + '/common/test/data/uploads/' + file_name

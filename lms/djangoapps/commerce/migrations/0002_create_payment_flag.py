...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        orm['waffle.Flag'].objects.create(name='use-ecommerce-payment-flow')

    def backwards(self, orm):
        orm['waffle.Flag'].objects.get(name='use-ecommerce-payment-flow').delete()
